...
public class PreRunPlanActivity extends AppCompatActivity {
    /**
     * For logging
     */
    private static final String TAG = PreRunPlanActivity.class.getSimpleName();
    ...
    RelativeLayout distance_scheme;

    @BindView(R.id.speed_scheme)
    RelativeLayout speed_scheme;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pre_run_plan);
        ...
        // Why do we sometimes have here a value???
        outdoorAppState.setWorkout(null);
        ...
        distance_and_time.setTypeface(Utils.getFontBebasNeue(this));

        distance_and_time.setText(getString(R.string.distance_and_time, selectedTraining.getDistanceMeters() / 1000.0, DateUtils.durationToMinSec(selectedTraining.getDuration())));
        ...
        if (selectedPlan.getFocus() == Plan.Focus.Distance) {
            distance_scheme.setVisibility(View.VISIBLE);
            speed_scheme.setVisibility(View.GONE);

        }
        else {
            distance_scheme.setVisibility(View.GONE);
            speed_scheme.setVisibility(View.VISIBLE);
        }
    ...
    private void finishIntent() {
        Intent intentQuickStart = new Intent(PreRunPlanActivity.this, OutdoorRunningActivity.class);
    ...
    public void TrainingDetails(View view) {
        Intent intent = new Intent(PreRunPlanActivity.this, TrainingDetailsActivity.class);
        startActivity(intent);
    }
        ...
        if (shouldProvideRationale) {
            ...
            Snackbar.make(findViewById(android.R.id.content), R.string.location_permission_rationale, Snackbar.LENGTH_INDEFINITE).
                    setAction(getString(android.R.string.ok), new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            // Request permission
                            ActivityCompat.requestPermissions(PreRunPlanActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, MY_PERMISSION_ACCESS_FINE_LOCATION_REQUEST_CODE);
                        }
                    }).show();
        }
        else {
        ...
        mSettingsClient.checkLocationSettings(mLocationSettingsRequest)
                .addOnSuccessListener(this, new OnSuccessListener<LocationSettingsResponse>() {
                    ...
                    public void onSuccess(LocationSettingsResponse locationSettingsResponse) {
                        ...
                        if (ActivityCompat.checkSelfPermission(PreRunPlanActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                            return;
                        }
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    ...
                                    rae.startResolutionForResult(PreRunPlanActivity.this, REQUEST_CHECK_SETTINGS);
                                } catch (IntentSender.SendIntentException sie) {
                                    Log.i(TAG, "PendingIntent unable to execute request.", sie);
                                }
                                break;
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                Toast.makeText(PreRunPlanActivity.this, R.string.location_setting_inadequate_fix_them, Toast.LENGTH_LONG).show();
                        }
                    }
                });
    }
